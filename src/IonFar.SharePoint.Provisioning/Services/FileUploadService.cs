...
namespace IonFar.SharePoint.Provisioning.Services
{
    ...
    public class FileUploadService : IFileUploadService
    {
        ...
        public Folder EnsureFolder(Web web, string folderPrefixedUrl)
        {
            ...
            var folderServerRelativeUrl = UrlUtility.ResolveServerRelativeUrl(_clientContext.Site, web, folderPrefixedUrl);
        ...
        public File UploadFile(string sourcePath, Web web, string folderPrefixedUrl, string destinationName, bool checkout)
        {
            ...
            var fileUrl = UrlUtility.Combine(folderServerRelativeUrl, destinationName);
        ...
        public void UploadFolder(string sourcePath, Web web, string destinationPrefixedUrl, IHashProvider hashProvider)
        {
            ...
            var destinationServerRelativeUrl = UrlUtility.ResolveServerRelativeUrl(_clientContext.Site, web, destinationPrefixedUrl);
            ...
            foreach (var filePath in filePaths)
            {
                ...
                var fileUrl = UrlUtility.Combine(destinationServerRelativeUrl, fileName);
